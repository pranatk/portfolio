...
function App() {
  ...
  return (
    <div className="bg-slate-900 leading-relaxed text-slate-400 antialiased min-h-screen selection:bg-teal-300 selection:text-teal-900">
      <header className="">
        <title>Pranat Karode</title>
      </header>
      <div
        onMouseMove={(e) => {
          setPos({ x: e.screenX, y: e.screenY });
        }}
        className=" fixed inset-0  transition duration-300 min-h-screen lg:absolute  text-slate-400"
      >
        <div
        ...
        >
          <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
            <div className="lg:flex lg:justify-between lg:flex-row lg:gap-4">
              <div className="lg:flex-1 w-full ">
                <header className="lg:sticky  lg:top-0 lg:flex lg:h-screen  lg:flex-col lg:justify-between lg:py-24">
                  <div>
                    <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">
                      <a href="/">Pranat Karode</a>
                    </h1>
                    <h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
                      Software Engineer at BI Worldwide
                    </h2>
                    <p className="mt-4 max-w-xs leading-normal">
                      I build pixel-perfect, accessible products for web.
                    </p>
              ...
              <div className="pt-24 lg:w-1/2 lg:py-24">
                ...
                >
                  <div className="sticky top-0  -mx-6 mb-4 w-screen  px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
                    <h2 className="text-sm font-bold uppercase tracking-widest text-slate-200 lg:sr-only">
                      About
                    </h2>
                  </div>
                  <div className="text-[1rem] leading-8">
                    <p className="mb-4">
                      Back in 2012, I decided to try my hand at creating custom
                      Tumblr themes and tumbled head first into the rabbit hole
                ...
                <section
                  ...
                  className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24"
                >
                  <div className="sticky top-0  -mx-6 mb-4 w-screen h-full px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
                    <div>
                      <ol className="group/list">
                        {experineces.map((details, i) => {
                          return (
